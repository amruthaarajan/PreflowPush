...
public class SimpleGraph {
    ...
    public Edge returnEdgeBetweenVertices(Vertex v1,Vertex v2)
    {
        Iterator it = v1.incidentEdgeList.iterator();
        while (it.hasNext()) {
            Edge e = (Edge) it.next();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Edge between the vertices (a,b) is: " + G.returnEdgeBetweenVertices(a,b).getName());
